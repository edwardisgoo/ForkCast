  ...
  runApp(
    MultiProvider(
      providers: [
        ...
        ChangeNotifierProxyProvider2<FiltersNotifier, List<Meal>, FilteredMealsNotifier>(
          create: (_) => FilteredMealsNotifier(),
          update: (_, filtersNotifier, meals, filteredNotifier) => filteredNotifier!
            ..updateFilteredMeals(meals, filtersNotifier.filters),
        ),
      ],
      child: const App(),
    ),
